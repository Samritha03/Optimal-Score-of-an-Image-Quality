...
class TestBRISQUE(unittest.TestCase):
    def setUp(self):
        self._paths = [
            root_path('images','sample3.jpg'),
            root_path('images','sample1.jpg')]

        # These feature are extracted from the original Matlab code of the distorted image above 
        self._brisque_feats = [
            np.array([
    ...
    def test_get_feature(self):
        ...
        # brisque = BRISQUE()
        # image = cv2.imread('/Users/samritha/VisualCode/OptimalScoreForAnImageQuality/Images/sample3.jpg')
        # feature = brisque.get_feature(image)
